...
param_basicos  <- list( "cp"= -0.908648104,  #complejidad minima
                        "minsplit"=   2991,     #minima cantidad de registros en un nodo para hacer el split
                        "minbucket"=  874,     #minima cantidad de registros en una hoja
